...
import { Award, MessageCircle, Mail, Phone, MapPin, Clock, Send, Facebook, Twitter, Instagram, Linkedin } from 'lucide-react'
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Have questions or need assistance? Our team is here to help you with any inquiries about the State of
                Origin Certificate process.
              </p>
            </div>
            <div className="md:w-1/2 relative">
              ...
              <div className="relative bg-white p-4 rounded-lg shadow-lg">
                <img
                  src="https://images.unsplash.com/photo-1556745753-b2904692b3cd?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80"
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Choose your preferred method of communication</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-green-50 p-6 rounded-lg border border-green-100 flex flex-col items-center text-center">
              ...
              <Button
                variant="outline"
                className="mt-auto border-green-600 text-green-600 hover:bg-green-50"
              >
                Start Chat
              </Button>
            </div>
            ...
            <div className="bg-teal-50 p-6 rounded-lg border border-teal-100 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 mb-4">Speak directly with our support team during business hours</p>
              <Button
                variant="outline"
                ...
                <div className="p-8 bg-green-600 text-white">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-100">+234 803 456 7890</p>
                        <p className="text-sm text-green-100">+234 905 678 1234</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-100">support@stateorigin.gov.ng</p>
                        <p className="text-sm text-green-100">info@stateorigin.gov.ng</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-100">Block 5a State Secretariat,</p>
                        <p className="text-sm text-green-100">Government House</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-100">Monday - Friday: 8:00 AM - 4:00 PM</p>
                        <p className="text-sm text-green-100">Closed on Weekends & Public Holidays</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-8">
                    ...
                    <div className="flex space-x-4">
                      <a
                        href="#"
                        className="bg-green-500 p-2 rounded-full hover:bg-green-400 transition-colors"
                      >
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Visit our office during working hours</p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Quick answers to common questions about contacting us</p>
          </div>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Our customer support team is available Monday through Friday, from 8:00 AM to 4:00 PM. We are closed on
                weekends and public holidays.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-medium mb-2">How quickly will I receive a response to my inquiry?</h3>
              <p className="text-gray-600">
                We aim to respond to all inquiries within 24 hours during business days. For complex issues, it may take
                up to 48 hours to provide a comprehensive response.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-medium mb-2">Can I schedule an in-person appointment?</h3>
              <p className="text-gray-600">
                Yes, you can schedule an in-person appointment by calling our office or using the contact form above.
                Please provide your preferred date and time, and we'll confirm availability.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-medium mb-2">How can I check the status of my application?</h3>
              <p className="text-gray-600">
                You can check the status of your application by logging into your account on our portal. If you need
                additional information, please contact our support team with your application reference number.
              </p>
            </div>
          </div>
        </div>

          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Learn more about our mission to streamline the State of Origin Certificate process and preserve our
                cultural heritage.
              </p>
            </div>
            <div className="md:w-1/2 relative">
              ...
              <div className="relative bg-white p-4 rounded-lg shadow-lg">
                <img
                  src="https://images.unsplash.com/photo-1568634761634-8d7c8d9291ef?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80"
                  alt="Nigerian government officials in meeting"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We are dedicated to preserving cultural identity while making the certificate process accessible to all
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-green-50 p-6 rounded-lg border border-green-100">
              ...
              <p className="text-gray-600">
                We've simplified the traditionally complex process of obtaining a State of Origin Certificate through
            ...
            <div className="bg-emerald-50 p-6 rounded-lg border border-emerald-100">
              ...
              <p className="text-gray-600">
                We believe in the importance of preserving cultural heritage and helping citizens maintain their
            ...
            <div className="bg-teal-50 p-6 rounded-lg border border-teal-100">
              ...
              <p className="text-gray-600">
                Our platform makes the certificate process accessible to all citizens, regardless of their location or
                technical expertise.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 relative order-2 md:order-1">
              ...
              <div className="relative bg-white p-4 rounded-lg shadow-lg">
                <img
                  ...
                  alt="Professional handshake symbolizing government service"
                  className="rounded-md w-full h-auto object-cover aspect-[4/3]"
                />
              </div>
            </div>
            <div className="md:w-1/2 space-y-6 order-1 md:order-2">
              ...
              <p className="text-gray-600">
                The State of Origin Certificate Portal was established in response to the challenges citizens faced when
                trying to obtain their certificates through traditional channels. Long queues, excessive paperwork, and
                lengthy processing times were common issues.
              </p>
              <p className="text-gray-600">
                Recognizing these challenges, we developed a digital solution that maintains the integrity of the
                verification process while significantly improving the user experience. Since our launch, we have helped
                thousands of citizens obtain their certificates quickly and securely.
              </p>
              <p className="text-gray-600">
                Our platform continues to evolve based on user feedback and technological advancements, ensuring we
      ...
      <section className="py-16 bg-green-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="max-w-2xl mx-auto mb-8">
            Apply for your State of Origin Certificate today and experience our streamlined process
          </p>
